...
IUSE="doc"
NUM="b5a1739fbc7bcbdcdadadb822343a0479789839b"
SRC_URI="https://gitlab.gnome.org/GNOME/${PN}/-/archive/${NUM}/${PN}-${NUM}.tar.bz2 -> ${P}.tar.bz2"

COMMON_DEPEND="
	>=x11-libs/pango-1.41.0[${MULTILIB_USEDEP}]
	>=dev-cpp/glibmm-2.48.0:2[${MULTILIB_USEDEP}]
	>=dev-cpp/cairomm-1.15.4[${MULTILIB_USEDEP}]
