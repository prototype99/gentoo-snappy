...
src_prepare() {
	...
	if use arm64; then
		eapply "${FILESDIR}/mozilla1442583.patch"
		eapply "${FILESDIR}/mozilla1445907.patch"
		eapply "${FILESDIR}/mozilla1447359.patch"
		eapply "${FILESDIR}/mozilla1456556.patch"
	fi

	if use debug; then
		eapply "${FILESDIR}/Don-t-build-testing-suites-and-stuff.patch"
		eapply "${FILESDIR}/Don-t-build-testing-suites-and-stuff-part-2.patch"
	fi
