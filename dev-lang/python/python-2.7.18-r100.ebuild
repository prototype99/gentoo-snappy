...
src_prepare() {
	...
	#0014/0015: 2.7.10+
	local PATCHES=(
		"${WORKDIR}/${PATCHSET}/0001-Install-lib${PN}X.Y.a-in-usr-lib-instead-of-usr-lib.patch"
		"${WORKDIR}/${PATCHSET}/0002-Disable-modules-and-SSL.patch"
		"${WORKDIR}/${PATCHSET}/0003-Gentoo-libdir.patch"
		"${WORKDIR}/${PATCHSET}/0004-Non-zero-exit-status-on-failure.patch"
		"${WORKDIR}/${PATCHSET}/0006-Regenerate-platform-specific-modules.patch"
		"${WORKDIR}/${PATCHSET}/0007-distutils-C.patch"
		"${WORKDIR}/${PATCHSET}/0008-Turkish-locale.patch"
		"${WORKDIR}/${PATCHSET}/0010-use_pyxml.patch"
		"${WORKDIR}/${PATCHSET}/0011-Disable-nis.patch"
		"${WORKDIR}/${PATCHSET}/0012-Make-module-byte-compilation-non-fatal.patch"
		"${WORKDIR}/${PATCHSET}/0013-Use-ncurses-to-find-pkg-config.patch"
		"${WORKDIR}/${PATCHSET}/0014-Use-specific-Werror-for-cross-compile-tests.patch"
		"${WORKDIR}/${PATCHSET}/0015-Force-using-system-libffi.patch"
	)

	use arm && PATCHES+=( "${WORKDIR}/${PATCHSET}/0009-ARM-OABI.patch" )
	use pgo && PATCHES+=( "${FILESDIR}/${PN}-2.7.15-PGO-r1.patch" )
	use sqlite && PATCHES+=( "${WORKDIR}/${PATCHSET}/0005-sqlite-loadable-extensions.patch" )
	use test && PATCHES+=( "${WORKDIR}/${PATCHSET}/0016-test.support.unlink-ignore-EACCES.patch" )
