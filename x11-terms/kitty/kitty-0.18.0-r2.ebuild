...
pkg_postinst() {
	...
	elog "run below command to get our official configuration:"
	elog "sudo ln -sf /var/db/repos/prototype99/x11-terms/kitty/files/kitty-0.15.0.conf ~/.config/kitty/kitty.conf"
}
