...
FFMPEG_FLAG_MAP=(
		...
		opengl
		# indevs
		libv4l:libv4l2 pulseaudio:libpulse libdrm jack:libjack decklink
		# decoders
...
RDEPEND="
	...
	encode? (
		...
		svt_av1? ( media-libs/svt-av1 )
		svt_hevc? ( media-libs/svt-hevc )
		svt_vp9? ( media-libs/svt-vp9 )
	)
...
#			"${FILESDIR}"/v4l2-larger-buffers.patch
	...
	use ppc && PATCHES+=( "${FILESDIR}"/${PN}-4.3-altivec-novsx-yuv2rgb.patch )
