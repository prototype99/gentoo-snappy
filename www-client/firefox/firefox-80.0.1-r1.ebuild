...
IUSE="asm bindist buffer clang cpu_flags_x86_avx2 dbus debug egl eme-free flash geckodriver kde
	...
	+system-webp test wayland wifi cross-lto full-lto thinlto"
