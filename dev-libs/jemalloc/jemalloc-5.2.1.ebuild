...
IUSE="abi_x86_32 debug hardened lazy-lock prof static-libs stats xmalloc"
HTML_DOCS=( doc/jemalloc.html )
PATCHES=(
	"${FILESDIR}/${PN}-5.2.0-gentoo-fixups.patch"
	"${FILESDIR}/${PN}-5.2.1-x32.patch"
)
