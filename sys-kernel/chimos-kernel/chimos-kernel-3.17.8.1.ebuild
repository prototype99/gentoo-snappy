...
src_prepare() {
	...
	local config_tweaks=(
		...
		-e '/CONFIG_BCM_WIMAX/s:.*:CONFIG_BCM_WIMAX=n:'
		-e '/CONFIG_BLK_DEV_INITRD/s:.*:CONFIG_BLK_DEV_INITRD=n:'
		-e '/CONFIG_BLK_DEV_FD/s:.*:CONFIG_BLK_DEV_FD=n:'
		-e '/CONFIG_BLK_DEV_MD/s:.*:CONFIG_BLK_DEV_MD=n:'
		-e '/CONFIG_BLK_DEV_PCIESSD_MTIP32XX/s:.*:CONFIG_BLK_DEV_PCIESSD_MTIP32XX=n:'
		-e '/CONFIG_BLK_DEV_SD/s:.*:CONFIG_BLK_DEV_SD=n:'
		-e '/CONFIG_BLK_DEV_SR/s:.*:CONFIG_BLK_DEV_SR=n:'
		-e '/CONFIG_BONDING/s:.*:CONFIG_BONDING=n:'
		-e '/CONFIG_CAIF/s:.*:CONFIG_CAIF=n:'
		-e '/CONFIG_CAIF_HSI/s:.*:CONFIG_CAIF_HSI=n:'
		-e '/CONFIG_CAIF_SPI_SLAVE/s:.*:CONFIG_CAIF_SPI_SLAVE=n:'
		-e '/CONFIG_CAIF_TTY/s:.*:CONFIG_CAIF_TTY=n:'
		-e '/CONFIG_CAIF_VIRTIO/s:.*:CONFIG_CAIF_VIRTIO=n:'
		...
		-e '/CONFIG_DUMMY/s:.*:CONFIG_DUMMY=n:'
		-e '/CONFIG_DX_SEP/s:.*:CONFIG_DX_SEP=n:'
		-e '/CONFIG_EQUALIZER/s:.*:CONFIG_EQUALIZER=n:'
		-e '/CONFIG_ET131X/s:.*:CONFIG_ET131X=n:'
		-e '/CONFIG_F2FS_FS/s:.*:CONFIG_F2FS_FS=n:'
		-e '/CONFIG_FB_UVESA/s:.*:CONFIG_FB_UVESA=n:'
		-e '/CONFIG_FB_XGI/s:.*:CONFIG_FB_XGI=n:'
		-e '/CONFIG_FEALNX/s:.*:CONFIG_FEALNX=n:'
		-e '/CONFIG_FIREWIRE_SERIAL/s:.*:CONFIG_FIREWIRE_SERIAL=n:'
		-e '/CONFIG_FRAMEBUFFER_CONSOLE_ROTATION/s:.*:CONFIG_FRAMEBUFFER_CONSOLE_ROTATION=n:'
		-e '/CONFIG_GFS2_FS/s:.*:CONFIG_GFS2_FS=n:'
		-e '/CONFIG_HAMRADIO/s:.*:CONFIG_HAMRADIO=n:'
		-e '/CONFIG_HSR/s:.*:CONFIG_HSR=n:'
		-e '/CONFIG_HW_RANDOM/s:.*:CONFIG_HW_RANDOM=y:'
		-e '/CONFIG_HW_RANDOM_AMD/s:.*:CONFIG_HW_RANDOM_AMD=n:'
		-e '/CONFIG_HW_RANDOM_TIMERIOMEM/s:.*:CONFIG_HW_RANDOM_TIMERIOMEM=y:'
		-e '/CONFIG_HW_RANDOM_TPM/s:.*:CONFIG_HW_RANDOM_TPM=n:'
		-e '/CONFIG_HW_RANDOM_VIA/s:.*:CONFIG_HW_RANDOM_VIA=n:'
		-e '/CONFIG_HW_RANDOM_VIRTIO/s:.*:CONFIG_HW_RANDOM_VIRTIO=n:'
		...
		-e '/CONFIG_LTE_GDM724X/s:.*:CONFIG_LTE_GDM724X=n:'
		-e '/CONFIG_LUSTRE_FS/s:.*:CONFIG_LUSTRE_FS=n:'
		-e '/CONFIG_MACINTOSH_DRIVERS/s:.*:CONFIG_MACINTOSH_DRIVERS=n:'
		-e '/CONFIG_MACVLAN/s:.*:CONFIG_MACVLAN=n:'
		-e '/CONFIG_MEDIA_ANALOG_TV_SUPPORT/s:.*:CONFIG_MEDIA_ANALOG_TV_SUPPORT=n:'
		-e '/CONFIG_MEDIA_DIGITAL_TV_SUPPORT/s:.*:CONFIG_MEDIA_DIGITAL_TV_SUPPORT=n:'
		-e '/CONFIG_MEDIA_RADIO_SUPPORT/s:.*:CONFIG_MEDIA_RADIO_SUPPORT=n:'
		-e '/CONFIG_MEDIA_RC_SUPPORT/s:.*:CONFIG_MEDIA_RC_SUPPORT=n:'
		-e '/CONFIG_NCP_FS/s:.*:CONFIG_NCP_FS=n:'
		-e '/CONFIG_NET_9P/s:.*:CONFIG_NET_9P=n:'
		...
		-e '/CONFIG_NET_TEAM/s:.*:CONFIG_NET_TEAM=n:'
		...
		-e '/CONFIG_NETCONSOLE/s:.*:CONFIG_NETCONSOLE=n:'
		...
		-e '/CONFIG_NLMON/s:.*:CONFIG_NLMON=n:'
		...
		-e '/CONFIG_R8188EU/s:.*:CONFIG_R8188EU=n:'
		-e '/CONFIG_R8712U/s:.*:CONFIG_R8712U=n:'
		-e '/CONFIG_R8821AE/s:.*:CONFIG_R8821AE=n:'
		...
		-e '/CONFIG_STAGING_MEDIA/s:.*:CONFIG_STAGING_MEDIA=n:'
		-e '/CONFIG_STE_MODEM_RPROC/s:.*:CONFIG_STE_MODEM_RPROC=n:'
		-e '/CONFIG_TOUCHSCREEN_CLEARPAD_TM1217/s:.*:CONFIG_TOUCHSCREEN_CLEARPAD_TM1217=n:'
		-e '/CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI4/s:.*:CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI4=n:'
		-e '/CONFIG_TUN/s:.*:CONFIG_TUN=n:'
		...
		-e '/CONFIG_VIRT_DRIVERS/s:.*:CONFIG_VIRT_DRIVERS=n:'
		-e '/CONFIG_VIRTIO_BALLOON/s:.*:CONFIG_VIRTIO_BALLOON=n:'
		-e '/CONFIG_VIRTIO_BLK/s:.*:CONFIG_VIRTIO_BLK=n:'
		-e '/CONFIG_VIRTIO_CONSOLE/s:.*:CONFIG_VIRTIO_CONSOLE=n:'
		...
		-e '/CONFIG_WIMAX_GDM72XX/s:.*:CONFIG_WIMAX_GDM72XX=n:'
	...
	if use intel; then
		config_tweaks+=(
			...
			-e '/CONFIG_HW_RANDOM_INTEL/s:.*:CONFIG_HW_RANDOM_INTEL=y:'
		...
		config_tweaks+=(
			...
			-e '/CONFIG_HW_RANDOM_INTEL/s:.*:CONFIG_HW_RANDOM_INTEL=n:'
