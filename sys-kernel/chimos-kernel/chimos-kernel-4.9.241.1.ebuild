...
src_prepare() {
	...
	local config_tweaks=(
		...
		-e '/CONFIG_AF_KCM/s:.*:CONFIG_AF_KCM=n:'
		-e '/CONFIG_AF_RXRPC/s:.*:CONFIG_AF_RXRPC=n:'
		...
		-e '/CONFIG_CRYPTO_DEV_PADLOCK/s:.*:CONFIG_CRYPTO_DEV_PADLOCK=n:'
		-e '/CONFIG_CRYPTO_DEV_QAT_DH895xCC/s:.*:CONFIG_CRYPTO_DEV_QAT_DH895xCC=n:'
		...
		-e '/CONFIG_IOSCHED_CFQ/s:.*:CONFIG_IOSCHED_CFQ=n:'
		-e '/CONFIG_IOSCHED_DEADLINE/s:.*:CONFIG_IOSCHED_DEADLINE=n:'
		...
		-e '/CONFIG_KERNEL_GZIP/d'
		-e '/CONFIG_KERNEL_LZ4/s:.*:CONFIG_KERNEL_LZ4=y:'
		-e '/CONFIG_LINE6_USB/s:.*:CONFIG_LINE6_USB=n:'
		-e '/CONFIG_LOCALVERSION=/d'
		-e '/CONFIG_LOCALVERSION_AUTO/s:.*:CONFIG_LOCALVERSION_AUTO=n:'
		-e '/CONFIG_LOG_BUF_SHIFT/s:.*:CONFIG_LOG_BUF_SHIFT=25:'
		...
		-e '/CONFIG_UNUSED_SYMBOLS/s:.*:CONFIG_UNUSED_SYMBOLS=n:'
		...
		-e '/CONFIG_WIMAX/s:.*:CONFIG_WIMAX=n:'
	...
	use amd || config_tweaks+=(
		...
		-e '/CONFIG_CRYPTO_DEV_CCP/s:.*:CONFIG_CRYPTO_DEV_CCP=n:'
	...
	if use debug; then
		...
		config_tweaks+=(
			...
			-e '/CONFIG_FRAME_POINTER/s:.*:CONFIG_FRAME_POINTER=n:'
			-e '/CONFIG_KALLSYMS/s:.*:CONFIG_KALLSYMS=y:'
			-e '/CONFIG_STACK_VALIDATION/s:.*:CONFIG_STACK_VALIDATION=n:'
		)
	fi
	if use ext4; then
		config_tweaks+=(
