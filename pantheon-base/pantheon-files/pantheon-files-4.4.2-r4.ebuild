...
LICENSE="GPL-3"
SLOT="0"
IUSE="gvfs img-dim-hover-list img-dim-jpg l10n_ar l10n_ca l10n_cs l10n_da l10n_es l10n_fr l10n_he l10n_ja l10n_nl l10n_pt l10n_pt-BR l10n_ru l10n_tr l10n_zh-CN mod-date-prop nls progress-icon +thumbnail-jpg unity zeitgeist"
...
RDEPEND="${DEPEND}
	...
	img-dim-jpg? ( x11-libs/gdk-pixbuf[jpeg] )
	thumbnail-jpg? ( xfce-extra/tumbler[jpeg] )
	dev-db/sqlite:3
	dev-libs/dbus-glib
